...
Q/E: Adjust size
G: Toggle grid
1-4: Change grid (3x4, 4x3, 3x3, 4x4)
P: Automatically detect rectangle
T: Toggle cell outlines
...
Q/E: Ajustar tamanho
G: Alternar grade
1-4: Mudar grid (3x4, 4x3, 3x3, 4x4)
P: Detectar retângulo automaticamente
T: Alternar outlines das células
R: Inverter direção de rotação
ESC: Sair